    ...
    <body>
        ...
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <img src="img/imges/m3.webp" width="100%" id="MainImg" alt="">
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="img/imges/m3.webp"width="100%" class="small-img" alt="">
            ...
            <div class="single-pro-details">
                <h6> Home/Dress</h6>
                <h4>COTTON KURTA TROUSER</h4>
                <h2>Rs. 6,000</h2>
                
                <input type="number" value="1">
                <button class="normal">Add To Cart</button>
                <h4>Product Details</h4>
                <span><b>Straight Kurta</b><br>
    
                    <b>Details:</b><br>
                    Embroidered Front, Plain Back, Full Sleeves, Band Neckline<br>
                    <b>Colour:</b> black<br>
                    <b>Fabric:</b> Poly Viscose Jacquard</span>
