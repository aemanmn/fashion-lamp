    ...
    <body>
        ...
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <img src="img/gulahmad/ms2.webp" width="100%" id="MainImg" alt="">
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="img/gulahmad/ms2.webp"width="100%" class="small-img" alt="">
            ...
            <div class="single-pro-details">
                ...
                <h4>BLACK TEXTURED PESHAWARI CHAPPAL</h4>
                <h2>PKR 2,617.50</h2>
                <select>
                ...
                <span>Traditional Peshawari Chappal For Men Made with High Chrome Textured Material and Rubber Sole<br>
                    <b>More Information</b><br>
                    
                    <b>Color:</b>	Brown<br>
                    <b>Product Category:</b>	Men Peshawari Chappal<br>
