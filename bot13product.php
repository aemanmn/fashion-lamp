    ...
    <body>
        ...
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <img src="img/bonanza/mf6.webp" width="100%" id="MainImg" alt="">
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="img/bonanza/mf6.webp"width="100%" class="small-img" alt="">
                    ...
                    <div class="small-img-col">
                        <img src="img/bonanza/mf7.webp"width="100%" class="small-img" alt="">
            ...
            <div class="single-pro-details">
                <h6> Home/Dress</h6>
                <h4>SUPER STAR POUR HOMME | HUMAYUN SAEED</h4>
                <h2>PKR 5,950.00</h2>
                
                <input type="number" value="1">
                <button class="normal">Add To Cart</button>
                <h4>Product Details</h4>
                <span><b>Category:</b> Fougere, Aromatic<br>

                    <b>Main Accords</b><br>
                    <b>Top Notes:</b> Clary Sage, Grapefruit, Lavender<br>
                    <b>Heart Notes:</b> Geranium, Mint, Watery<br>
                    <b>Base Notes:</b> Leather, Vetiver, Dry Amber<br>
                    
                    <b>Size:</b> 100ml Bottle</span>
