    ...
    <body>
        ...
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <img src="img/imges/wun10.webp" width="100%" id="MainImg" alt="">
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="img/imges/wun10.webp"width="100%" class="small-img" alt="">
            ...
            <div class="single-pro-details">
                <h6> Home/Dress</h6>
                <h4>LIGHT PINK LAWN UNSTITCHED 3PC</h4>
                <h2>PKR 3,500.00</h2>
                
                <input type="number" value="1">
                <button class="normal">Add To Cart</button>
                <h4>Product Details</h4>
                <span><b>Embroidered 3 Piece</b><br>

                    <b>Printed Lawn Dupatta:</b> 2.5 Meters<br>
                    <b>Printed Lawn Shirt:</b> 1.75 Meter<br>
                    <b>Lawn Trouser:</b> 1.7 Meter<br>
                    
                   
                    <b>More Information</b><br>
                    <b>Size:</b>	3 Piece<br>
                    <b>Color:</b>light pink<br>
                    <b>Product Category:</b>	Unstitched 3 Piece<br>
                    <b>Collection:</b>	Festive Collection-II '23<br>
                    <b>Fabric:</b>	Lawn<br>
                    <b>Disclaimer:</b>	Due to the photographic lighting & different screen calibrations, the colors of the original product may slightly vary from the picture</span>
</span>
