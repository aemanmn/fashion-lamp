    ...
    <body>
        ...
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <img src="img/limelight/wv5.webp" width="100%" id="MainImg" alt="">
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="img/limelight/wv5.webp"width="100%" class="small-img" alt="">
            ...
            <div class="single-pro-details">
                ...
                <span>Description<br>
                    Wallet with envelope shaped flap<br>
                    Two glossy stripes on the wallet<br>
                    Magnetic fastener<br>
                    Three compartments (one zipped)<br>
                    One coin compartment<br>
                    Four cards slots<br>
                    <b>Color: </b>Beige<br>
                    <b>Material: </b>Rexine<br>
                    <b>Dimensions:</b> 8" W x 4" H x 1" D<br>
                    <b>Weight:</b> 172 g<br>
                    <b>Code:</b> LW49501-FRE-BGE</span>
