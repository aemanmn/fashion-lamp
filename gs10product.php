    ...
    <body>
        ...
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <img src="img/gulahmad/mw3.webp" width="100%" id="MainImg" alt="">
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="img/gulahmad/mw3.webp"width="100%" class="small-img" alt="">
            ...
            <div class="single-pro-details">
                <h6> Home/Dress</h6>
                <h4>Blue Paisley Printed Casual Shirt</h4>
                <h2>PKR 2,000</h2>
                <select>
                ...
                <span>Created with premium quality material, Casual Shirts from Ideas Man are perfect for every occasion.<br>

                    Cotton<br>
                    Regular Fit<br>
                    Model Specs: The model is 6’1 and is wearing size Medium</span>
