    ...
    <body>
        ...
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <img src="img/imges/mun13.webp" width="100%" id="MainImg" alt="">
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="img/imges/mun13.webp"width="100%" class="small-img" alt="">
                    ...
                    <div class="small-img-col">
                        <img src="img/imges/mun13webp"width="100%" class="small-img" alt="">
            ...
            <div class="single-pro-details">
                <h6> Home/Dress</h6>
                <h4>COTTON UNSTITCHED KAMEEZ SHALWAR</h4>
                <h2>PKR 4,230.00</h2>
                
                <input type="number" value="1">
                <button class="normal">Add To Cart</button>
                <h4>Product Details</h4>
                <span><b>More Information</b><br>
                    
                    <b>Size:</b>4.5 Meters<br>
                    <b>Color:</b>Espresso Brown<br>
                    <b>Collection:</b>Winter Collection '21<br>
                    <b>Fabric:</b>	Cotton<br>
