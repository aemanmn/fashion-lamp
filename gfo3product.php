    ...
    <body>
        ...
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <img src="img/gulahmad/wf4.webp" width="100%" id="MainImg" alt="">
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="img/gulahmad/wf4.webp"width="100%" class="small-img" alt="">

                    </div>
                    <div class="small-img-col">
                        <img src="img/gulahmad/mf4.webp"width="100%" class="small-img" alt="">
