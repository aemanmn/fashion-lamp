    ...
    <body>
        ...
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <img src="img/j/m8.webp" width="100%" id="MainImg" alt="">
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="img/j/m8.webp"width="100%" class="small-img" alt="">
        ...
        <section id="newsletter" class="section-p1 section-m1">
            ...
            <div class="form">
                ...
                <a href="signu.php"> <button class="normal">Sign Up</button> </a>
            </div>
        </section>
