    ...
    <body>
        ...
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <img src="img/imges/ww4.webp" width="100%" id="MainImg" alt="">
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="img/imges/ww4.webp"width="100%" class="small-img" alt="">
            ...
            <div class="single-pro-details">
                <h6> Home/Dress</h6>
                <h4>PULL-ON LOOSE-FIT LINEN TROUSERS</h4>
                <h2>Rs.2,990.00</h2>
                <select>
                ...
                <span>Button through linen shirt with collar. Full sleeves and patch pockets.
                    
                    <b>Details:</b><br>
                    <b>Colour:</b> yellow<br>
                    <b>Fabric:</b> Linen<br>
                    
                    <b>Size & Fit</b><br>
                    <b>Model Height:</b> 5 Feet 4 Inches<br>
                    <b>Model Wears:</b> S<br>
