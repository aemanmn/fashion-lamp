    ...
    <body>
        ...
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <img src="img/sapphire/b13.webp" width="100%" id="MainImg" alt="">
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="img/sapphire/b13.webp"width="100%" class="small-img" alt="">
            ...
            <div class="single-pro-details">
                <h6> Home/Dress</h6>
                <h4>SAND COTTON KAMEEZ SHALWAR</h4>
                <h2>PKR 2,767.50</h2>
                <select>
                ...
                <span><b>More Information</b><br>
                    ...
                    <b>Color:</b>Sand<br>
                    <b>Product Category:</b>Boys Kameez Shalwar<br>
