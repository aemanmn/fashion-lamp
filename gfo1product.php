    ...
    <body>
        ...
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <img src="img/gulahmad/wf2.webp" width="100%" id="MainImg" alt="">
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="img/gulahmad/wf2.webp"width="100%" class="small-img" alt="">
                    ...
                    <div class="small-img-col">
                        <img src="img/gulahmad/mf2.webp"width="100%" class="small-img" alt="">
