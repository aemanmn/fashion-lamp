    ...
    <body>
        ...
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <img src="img/sapphire/m2.webp" width="100%" id="MainImg" alt="">
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="img/sapphire/m2.webp"width="100%" class="small-img" alt="">
                    ...
                    <div class="small-img-col">
                        <img src="img/sapphire/m3.webp"width="100%" class="small-img" alt="">
