    ...
    <body>
        ...
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <img src="img/beechtree/ww10.webp" width="100%" id="MainImg" alt="">
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="img/beechtree/ww10.webp"width="100%" class="small-img" alt="">
            ...
            <div class="single-pro-details">
                <h6> Home/Dress</h6>
                <h4>PULL-ON LOOSE-FIT LINEN TROUSERS/SHIRT</h4>
                <h2>Rs.2,990.00</h2>
                <select>
                ...
                <span>
                    Button through linen shirt with collar. Full sleeves and patch pockets.
                    ...
                    <b>Note:</b> Actual product color may vary slightly from the image.
