    ...
    <body>
        ...
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <img src="img/imges/ww2.webp" width="100%" id="MainImg" alt="">
                <div class="small-img-group">
                    <div class="small-img-col">
                        <img src="img/imges/ww2.webp"width="100%" class="small-img" alt="">
            ...
            <div class="single-pro-details">
                <h6> Home/Dress</h6>
                <h4>PULL-ON WIDE-LEG LINEN TROUSERS</h4>
                <h2>Rs.3,490.00</h2>
                <select>
